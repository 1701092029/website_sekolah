...
class Agenda extends CI_Controller
{
    ...
    function index()
    {
        ...
        $limit = 5;
        $config['base_url'] = base_url() . 'frontend/agenda/index/';
        ...
        $x['data'] = $this->Admin_model->agenda_perpage($limit, $offset, $data['keyword_berita']);

        $this->load->view('Frontend/Template/header', $x);
        $this->load->view('Frontend/v_agenda', $x);
