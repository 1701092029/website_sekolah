                             ...
                             <table id="example1" class="table table-striped" style="font-size:13px;">
                                 ...
                                 <tbody>
                                     <?php foreach ($data->result_array() as $i) :
                                            ...
                                            $pengguna_jenkel = $i['jekel'];
                                            $pengguna_email = $i['email'];
                                            $pengguna_password = $i['password'];
                                            $pengguna_nohp = $i['no_telp'];
                                            $pengguna_level = $i['role_id'];
                                            $pengguna_active = $i['is_active'];
                                        ?>
                                         <tr>
                                             ...
                                             <td style=" text-align:right;">
                                                 ...
                                                 <a class="btn" href="<?php echo base_url() . 'admin/reset-pengguna/' . $pengguna_id; ?>"><span class="fa fa-refresh"></span></a>
 ...
 <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
     <div class="modal-dialog" role="document">
         <div class="modal-content">
             ...
             <form class="form-horizontal" action="<?php echo base_url() . 'admin/tambah-pengguna' ?>" method="post" enctype="multipart/form-data">
                 <div class="modal-body">
                     ...
                     <div class="form-group">
                         <label for="inputUserName" class="col-sm-4 control-label">Level</label>
                         <div class="col-sm-7">
                             <select class="form-control" name="xactive" required>
     ...
     <div class="modal fade" id="ModalEdit<?php echo $pengguna_id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
         <div class="modal-dialog" role="document">
             <div class="modal-content">
                 ...
                 <form class="form-horizontal" action="<?php echo base_url() . 'admin/edit-pengguna' ?>" method="post" enctype="multipart/form-data">
                     <div class="modal-body">
     ...
     <div class="modal fade" id="ModalHapus<?php echo $pengguna_id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
         <div class="modal-dialog" role="document">
             <div class="modal-content">
                 ...
                 <form class="form-horizontal" action="<?php echo base_url() . 'admin/hapus-pengguna' ?>" method="post" enctype="multipart/form-data">
                     <div class="modal-body">
                         <input type="hidden" name="kode" value="<?php echo $pengguna_id; ?>" />
