...
<div id="bottom_seciton">
    <div id="footer">
        ...
        <div class="contact_us">
            <h5>Hubungi Kami</h5>
            <ul>
                <li class="telephone_no">(+62) 831-9343-5809</li>
                <li class="mailing_address">
                    Jl. Tengku Sidi, Sinur, Kec. Nan Sabaris, Kab.Padang Pariaman, Sumatera Barat
                </li>
                <li class="email_address"><a href="#">smp2nansabaris@gmail.com</a></li>
...
<div id="bottom_Section">
    ...
    <div id="pagebottom">
        <!-- copyright -->
        <div class="copyright">&copy; 2021 <a href="#">Satria Rahmat Putra</a> All Rights Reserved</div>
